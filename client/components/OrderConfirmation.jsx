  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto">
        {!isConfirmed ? (
          <>
            <h1 className="text-3xl font-bold mb-6 text-blue-950">Order Review</h1>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between mb-2">
                  <span className="text-gray-600">
                    Phone No Wadda zamu kiraka kaansa:
                  </span>
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold mb-4 text-blue-950">Order Confirmed!</h1>
